...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `FKk6iwsq3kts1bblivkjy6epajx`
...
CREATE TABLE `proveedores` (
  ...
  CONSTRAINT `FKtduja1lqu2fr99ud9289xcfqe`
    FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `herramientas` (
  ...
  CONSTRAINT `FKfk6nrr8hxyacg5bqbn51o2h0j`
    FOREIGN KEY (`categoria_id`) REFERENCES `categoria_herramientas` (`id`),
  CONSTRAINT `FKksrw997r6plty4sixxyjcickl`
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `FK3si71ogl7n3hqgsx79l2u4suf`
    FOREIGN KEY (`herramienta_id`) REFERENCES `herramientas` (`id`),
  CONSTRAINT `FKpays115gahfu3ffuywded1xqt`
...
CREATE TABLE `pagos` (
  ...
  CONSTRAINT `FKrd490715qtq2imjqrn0rwyhsl`
...
CREATE TABLE `devoluciones` (
  ...
  CONSTRAINT `FKopq6b4emmwhw89phlqtxouy4l`
    FOREIGN KEY (`reserva_id`) REFERENCES `reservas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `facturas` (
  ...
  CONSTRAINT `FKniyc4ntc4e02vcpyyfqku2cyj`
...
CREATE TABLE `imagenes_herramientas` (
  ...
  CONSTRAINT `FKhd1gsdb513swi8avhq8g9vvwk`
    FOREIGN KEY (`herramienta_id`) REFERENCES `herramientas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `reporte_incidencias` (
  ...
  CONSTRAINT `FKbqmbcjn4tfqg511bmwrku5xym`
    FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`),
  CONSTRAINT `FKcp8t8r4obv9hbx5fxd0qpvs3e`
    FOREIGN KEY (`herramienta_id`) REFERENCES `herramientas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
